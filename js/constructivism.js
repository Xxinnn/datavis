...
var urls1 = ["801", "804", "807", "810", "810", "815", "818"];
var urls2 = ["802", "805", "808", "811", "813", "816", "819"];
var urls3 = ["803", "806", "809", "812", "814", "817", "820"];
...
//        set src and id to image imported
        newImage1.setAttribute('src', 'img/constructivism/' + urls1[i] + '.jpg');
        newImage1.setAttribute('id',urls1[i]);
        newImage1.setAttribute('title',csv_artworkName[urls1[i]-661]);


    
        newImage2.setAttribute('src', 'img/constructivism/' + urls2[i] + '.jpg');
        newImage2.setAttribute('id',urls2[i]);
        newImage2.setAttribute('title',csv_artworkName[urls2[i]-661]);
        console.log(newImage2);
        
        newImage4.setAttribute('src', 'img/constructivism/' + urls3[i+1] + '.jpg');
        newImage4.setAttribute('id',urls3[i+1]);
        newImage4.setAttribute('title',csv_artworkName[urls3[i+1]-661]);
        console.log(newImage4);
        
        newImage5.setAttribute('src', 'img/constructivism/' + urls2[i+1] + '.jpg');
        newImage5.setAttribute('id',urls2[i+1]);
        newImage5.setAttribute('title',csv_artworkName[urls2[i+1]-661]);
        console.log(newImage5);

        
        newImage3.setAttribute('src', 'img/constructivism/' + urls3[i] + '.jpg');
        newImage3.setAttribute('id',urls3[i]);
        newImage3.setAttribute('title',csv_artworkName[urls3[i]-661]);
...
//        show img
    ...
    for (var t = 1; t < 21; t++){
        ...
        td = document.getElementById(800+t);
...
//             add layer
            ...
            callImage.setAttribute('src','img/constructivism/' + t_id + '.jpg');
             ...
             $('#artist').html( '<span>' + csv_artistName[t_id-661]+','+csv_time[t_id-661]+'</span>');
             $('#description').html( '<span>' + csv_description[t_id-661] + '</span>');
             $('#size').html('<span>'+'Dimension(cm): '+csv_size_cm[t_id-661]+'</span>');
